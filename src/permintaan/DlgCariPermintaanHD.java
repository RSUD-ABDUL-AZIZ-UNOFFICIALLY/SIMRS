...
public class DlgCariPermintaanHD extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public DlgCariPermintaanHD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        ppHemodialisa = new javax.swing.JMenuItem();
        ppAsesmenAwalMedis = new javax.swing.JMenuItem();
        ...
        TanggalPulang.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "04-09-2024 11:24:36" }));
        ...
        ppHemodialisa.setBackground(new java.awt.Color(255, 255, 254));
        ppHemodialisa.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppHemodialisa.setForeground(new java.awt.Color(50, 50, 50));
        ppHemodialisa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppHemodialisa.setText("Hemodialisa");
        ppHemodialisa.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppHemodialisa.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppHemodialisa.setName("ppHemodialisa"); // NOI18N
        ppHemodialisa.setPreferredSize(new java.awt.Dimension(200, 26));
        ppHemodialisa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppHemodialisaBtnPrintActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppHemodialisa);

        ppAsesmenAwalMedis.setBackground(new java.awt.Color(255, 255, 254));
        ppAsesmenAwalMedis.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppAsesmenAwalMedis.setForeground(new java.awt.Color(50, 50, 50));
        ppAsesmenAwalMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppAsesmenAwalMedis.setText("Asesmen Awal Medis");
        ppAsesmenAwalMedis.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppAsesmenAwalMedis.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppAsesmenAwalMedis.setName("ppAsesmenAwalMedis"); // NOI18N
        ppAsesmenAwalMedis.setPreferredSize(new java.awt.Dimension(200, 26));
        ppAsesmenAwalMedis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppAsesmenAwalMedisActionPerformed(evt);
            }
        });
        jPopupMenu1.add(ppAsesmenAwalMedis);
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Permintaan Hemodialisa ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        BtnCetakHasilDarah.setText("Cetak Permintaan HD");
...
//                        Logger.getLogger(DlgCariPermintaanDarah.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void ppHemodialisaBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppHemodialisaBtnPrintActionPerformed
    ...
    }//GEN-LAST:event_ppHemodialisaBtnPrintActionPerformed

    private void ppAsesmenAwalMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppAsesmenAwalMedisActionPerformed
        if(TabPilihRawat.getSelectedIndex()==0){
            if(TabRawatJalan.getSelectedIndex()==0){
                if(tbRadiologiRalan.getSelectedRow()!= -1){
                    if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
    ...
    }//GEN-LAST:event_ppAsesmenAwalMedisActionPerformed
                    ...
                    if(tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString().trim().equals("")){
                        ...
                        if(Sampel.equals("")||akses.getkode().equals("Admin Utama")){
                            if(Sequel.cariInteger("select count(noorder) from hasil_pemeriksaan_darah where noorder=?",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString())>0){
                                ...
                                Sequel.meghapus("permintaan_hd","noorder",tbRadiologiRalan.getValueAt(tbRadiologiRalan.getSelectedRow(),0).toString());
                                tampil();
                            }
                        }else{
                    ...
                    if(tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString().trim().equals("")){
                        ...
                        if(Sampel.equals("")||akses.getkode().equals("Admin Utama")){
                            if(Sequel.cariInteger("select count(noorder) from hasil_pemeriksaan_darah where noorder=?",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString())>0){
                                ...
                                Sequel.meghapus("permintaan_hd","noorder",tbRadiologiRanap.getValueAt(tbRadiologiRanap.getSelectedRow(),0).toString());
                                tampil3();
                            } 
                        }else{
                            JOptionPane.showMessageDialog(null,"Maaf, Sudah dilakukan pengambilan sampel...!!!!");
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgCariPermintaanHD dialog = new DlgCariPermintaanHD(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JMenuItem ppAsesmenAwalMedis;
    private javax.swing.JMenuItem ppHapusPermintaan;
    private javax.swing.JMenuItem ppHemodialisa;
    ...
    private void tampil() {
        ...
        try {
            ...
            ps=koneksi.prepareStatement(
                    "SELECT\n" +
                    "	permintaan_hd.noorder, \n" +
                    "	permintaan_hd.no_rawat, \n" +
                    "	permintaan_hd.tgl_permintaan, \n" +
                    "	permintaan_hd.jam_permintaan, \n" +
                    "	permintaan_hd.dokter, \n" +
                    "	dokter.nm_dokter, \n" +
                    ...
                    "	pasien.jk, \n" +
                    "	pasien.tgl_lahir, \n" +
                    "	permintaan_hd.`status`, \n" +
                    "	permintaan_hd.ruang, \n" +
                    "	permintaan_hd.tindakan, \n" +
                    "	permintaan_hd.diagnosa_sementara, \n" +
                    "	penjab.png_jawab, \n" +
                    "	penjab.kd_pj\n" +
                    "FROM\n" +
                    "	permintaan_hd\n" +
                    ...
                    "	reg_periksa\n" +
                    "	ON \n" +
                    "		permintaan_hd.no_rawat = reg_periksa.no_rawat\n" +
                    "	INNER JOIN\n" +
                    "	pasien\n" +
                    "	ON \n" +
                    ...
                    "	dokter\n" +
                    "	ON \n" +
                    "		permintaan_hd.dokter = dokter.kd_dokter \n" +
                    "	INNER JOIN\n" +
                    "	penjab\n" +
                    "	ON \n" +
                    "		reg_periksa.kd_pj = penjab.kd_pj \n"+
                    "where permintaan_hd.status='ralan' and permintaan_hd.tgl_permintaan between ? and ? "+
                    (semua?"":"and dokter.nm_dokter like ? and "+
                    "(permintaan_hd.noorder like ? or permintaan_hd.no_rawat like ? or reg_periksa.no_rkm_medis like ? "+
                    "or pasien.nm_pasien like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?) ")+
                    "order by permintaan_hd.tgl_permintaan,permintaan_hd.jam_permintaan desc");
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        Sequel.cariIsi("select tanggal from hemodialisa where no_rawat=? ",rs.getString("no_rawat")),
                        Sequel.cariIsi("select tanggal from penilaian_medis_hemodialisa where no_rawat=? ",rs.getString("no_rawat"))
                    });
    ...
    public void isCek(){
        BtnCetakHasilDarah.setEnabled(akses.gethemodialisa());
        ppHemodialisa.setEnabled(akses.gethemodialisa());
        ppAsesmenAwalMedis.setEnabled(akses.getpenilaian_medis_ralan_hemodialisa());
        ...
        try {
            ...
            if (cmbStatus.getSelectedIndex() == 1){
                ...
                ps=koneksi.prepareStatement(
                    ...
                    "where permintaan_hd.status='ranap' and permintaan_hd.tgl_permintaan between ? and ? "+statuspulang+
                    (semua?"":"and dokter.nm_dokter like ? and "+
                    "(permintaan_hd.noorder like ? or permintaan_hd.no_rawat like ? or reg_periksa.no_rkm_medis like ? "+
                    "or pasien.nm_pasien like ? or dokter.nm_dokter like ? or penjab.png_jawab like ?) ")+
                    "order by permintaan_hd.tgl_permintaan,permintaan_hd.jam_permintaan,kamar_inap.tgl_masuk desc");
