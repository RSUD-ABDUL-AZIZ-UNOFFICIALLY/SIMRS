...
public final class BPJSCekRujukanKartuPCare extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        labelNamePasienx = new widget.Label();
        ...
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2023" }));
        ...
        DTPDaftar.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2023" }));
        ...
        TanggalSEP.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "28-04-2023 16:37:25" }));
...
//        pasien.prop.setVisible(true);
    ...
    */
    ...
    private widget.Label labelNamePasienx;
...
//                Kelas.setSelectedItem(response.path("peserta").path("hakKelas").path("kode").asText()+". "+response.path("peserta").path("hakKelas").path("keterangan").asText().replaceAll("KELAS","Kelas"));
                ...
                try {
                    ...
                    if(rs.next()){
                        ...
                        labelNamePasienx.setText("("+rs.getString("nm_pasien")+")");
