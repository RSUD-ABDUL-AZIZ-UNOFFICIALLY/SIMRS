...
import rekammedis.RMLaporanOperasiLokalAnestesi;
...
public final class DlgKasirRalan extends javax.swing.JDialog {
    ...
    private final INACBGHybrid inacbgklaim=new INACBGHybrid(null,false);
    private final INACBGCariCoderNIK cariNIK=new INACBGCariCoderNIK(null,false);
    ...
    private String aktifkanparsial="no",kamar_inap_kasir_ralan=Sequel.cariIsi("select set_jam_minimal.kamar_inap_kasir_ralan from set_jam_minimal"),caripenjab="",filter="no",bangsal=Sequel.cariIsi("select set_lokasi.kd_bangsal from set_lokasi limit 1"),nonota="",
            ...
            variabel="",coder_nik="",pilihpage="",judulform="",aksiKorona="BukanCorona";
    ...
    public DlgKasirRalan(java.awt.Frame parent, boolean modal) {
        ...
        tabModekasir=new DefaultTableModel(null,new String[]{
            ...
            "Poliklinik","Penanggung Jawab","Alamat Pasien","Hubungan P.J.",
            "Biaya Reg","Jenis Bayar","Status","No.Rawat","Tanggal",
            "Jam","No.Reg","Status Bayar","Stts Poli","Kd PJ","Kd Poli","No.Telp Pasien","No.Peserta","NIK"}){
        ...
        tabModekasir2=new DefaultTableModel(null,new String[]{
            ...
            "Poliklinik Rujukan","Penanggung Jawab","Alamat Pasien","Hubungan P.J.",
            "Jenis Bayar","Status","No.Rawat","Tanggal","Jam","Kode Poli","Kode PJ","No.Telp Pasien","No.Peserta","NIK"}){
              @Override public boolean isCellEditable(int rowIndex, int colIndex){return false;}
        };
            ...
            public void keyPressed(KeyEvent e) {
                if(e.getKeyCode()==KeyEvent.VK_SPACE){
                    if(cariNIK.getTable().getSelectedRow()!= -1){                   
                        ...
                        inacbgklaim.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
    ...
    private void initComponents() {
        ...
        MnLaporanOperasiAnestesi = new javax.swing.JMenuItem();
        ...
        ppTBid = new javax.swing.JMenuItem();
        ...
        MnCoderManual2 = new javax.swing.JMenuItem();
        ...
        MSKKJ2 = new javax.swing.JMenuItem();
        ...
        WindowIdTB = new javax.swing.JDialog();
        internalFrame9 = new widget.InternalFrame();
        TxIdTb = new widget.TextBox();
        ...
        MnLaporanOperasi.setText("Lap. Operasi lokal ");
        ...
        MnLaporanOperasiAnestesi.setBackground(new java.awt.Color(255, 255, 254));
        MnLaporanOperasiAnestesi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnLaporanOperasiAnestesi.setForeground(new java.awt.Color(50, 50, 50));
        MnLaporanOperasiAnestesi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnLaporanOperasiAnestesi.setText("Lap. Operasi lokal Anestesi ");
        MnLaporanOperasiAnestesi.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnLaporanOperasiAnestesi.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnLaporanOperasiAnestesi.setName("MnLaporanOperasiAnestesi"); // NOI18N
        MnLaporanOperasiAnestesi.setPreferredSize(new java.awt.Dimension(210, 26));
        MnLaporanOperasiAnestesi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnLaporanOperasiAnestesiActionPerformed(evt);
            }
        });
        MnRMOperasi.add(MnLaporanOperasiAnestesi);
        ...
        ppTBid.setBackground(new java.awt.Color(255, 255, 254));
        ppTBid.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppTBid.setForeground(new java.awt.Color(50, 50, 50));
        ppTBid.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppTBid.setText("Isi ID TB");
        ppTBid.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppTBid.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppTBid.setName("ppTBid"); // NOI18N
        ppTBid.setPreferredSize(new java.awt.Dimension(210, 26));
        ppTBid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppTBidBtnPrintActionPerformed(evt);
            }
        });
        MnDataRM.add(ppTBid);
        ...
        MnCoderManual2.setBackground(new java.awt.Color(255, 255, 254));
        MnCoderManual2.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnCoderManual2.setForeground(new java.awt.Color(50, 50, 50));
        MnCoderManual2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCoderManual2.setText("Klaim Baru Manual INACBG 2");
        MnCoderManual2.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnCoderManual2.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        MnCoderManual2.setName("MnCoderManual2"); // NOI18N
        MnCoderManual2.setPreferredSize(new java.awt.Dimension(230, 26));
        MnCoderManual2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCoderManual2ActionPerformed(evt);
            }
        });
        MnBridging.add(MnCoderManual2);
        ...
        MSKKJ.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MSKKJ.setText("SKKJ");
        ...
        MSKKJ2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MSKKJ2.setText("SKKJ 2");
        MSKKJ2.setName("MSKKJ2"); // NOI18N
        MSKKJ2.setPreferredSize(new java.awt.Dimension(210, 26));
        MSKKJ2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MSKKJ2ActionPerformed(evt);
            }
        });
        MSKKJ.add(MSKKJ2);
        ...
        TglSakit1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-10-2024" }));
        ...
        TglSakit2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "14-10-2024" }));
        ...
        WindowIdTB.setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        WindowIdTB.setName("WindowIdTB"); // NOI18N
        WindowIdTB.setUndecorated(true);
        WindowIdTB.setResizable(false);

        internalFrame9.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Input ID TB ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 70, 50))); // NOI18N
        internalFrame9.setName("internalFrame9"); // NOI18N
        internalFrame9.setLayout(null);

        TxIdTb.setHighlighter(null);
        TxIdTb.setName("TxIdTb"); // NOI18N
        TxIdTb.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                TxIdTbKeyPressed(evt);
            }
        });
        internalFrame9.add(TxIdTb);
        TxIdTb.setBounds(60, 30, 180, 23);

        jLabel9.setText("ID TB :");
        jLabel9.setName("jLabel9"); // NOI18N
        internalFrame9.add(jLabel9);
        jLabel9.setBounds(0, 30, 57, 23);
        ...
        internalFrame9.add(BtnCloseIn2);
        BtnCloseIn2.setBounds(465, 30, 100, 30);
        ...
        internalFrame9.add(BtnHapus2);
        BtnHapus2.setBounds(360, 30, 100, 30);

        WindowIdTB.getContentPane().add(internalFrame9, java.awt.BorderLayout.CENTER);
    ...
    private void tbKasirRalanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKasirRalanMouseClicked
        if(tabModekasir.getRowCount()!=0){
            ...
            if(evt.getClickCount()==1){
                if(tbKasirRalan.getSelectedColumn()==4){
                    int reply = JOptionPane.showConfirmDialog(rootPane,"Asesmen= "+Sequel.cariIsi("select coalesce(penilaian,'Belum Ada data') from pemeriksaan_ralan where no_rawat=?",TNoRw.getText()),"Menuju Menu Diagnosa?",JOptionPane.YES_NO_OPTION);
                ...
                if(i==0){
                    ...
                    MnCoderManual2ActionPerformed(null);
                }else if(i==7){
                    if(akses.getinacbg_klaim_baru_manual2()==true){
                        if(akses.getkode().equals("Admin Utama")){
                            ...
                            cariNIK.setSize(internalFrame1.getWidth(),internalFrame1.getHeight());
                            cariNIK.setLocationRelativeTo(internalFrame1);
                            ...
                            if(!coder_nik.equals("")){
                                ...
                                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                                try {
                                    inacbgklaim.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"inacbg/login.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&page=KlaimBaruManual2&codernik="+coder_nik);                    
                                } catch (Exception ex) {
                                    System.out.println("Notifikasi : "+ex);
                                }
                        ...
                        JOptionPane.showMessageDialog(null,"Akun Bukan Coder..!!");
                    }                   
                }
            }
        }
...
private void MnDataPemberianObatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataPemberianObatActionPerformed
    ...
    private void MnDataSEPActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnDataSEPActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()!= -1){
                ...
                dlgki.setLocationRelativeTo(internalFrame1);
                dlgki.isCek();
                dlgki.setNoRm3(TNoRw.getText(),Valid.SetTgl2(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),12).toString()),tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),2).toString());   
                dlgki.setVisible(true);
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    ...
    private void MSKKJ2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MSKKJ2ActionPerformed
        JComboBox optionList = new JComboBox();
        try{
            ps=koneksi.prepareStatement("select nama from template_skkj ");
            try{
        ...
        if(TPasienCari.getText().trim().equals("")){
            ...
            if(tbKasirRalan2.getSelectedRow()!= -1){
                ...
                param.put("logo",Sequel.cariGambar("select setting.logo from setting"));
                param.put("logo2",Sequel.cariGambar("select setting.logo from setting"));
                Valid.MyReport("rptSKKJv2.jasper",param,"::[ SKKJ 2 ]::");
                this.setCursor(Cursor.getDefaultCursor());
            }
        }
    }//GEN-LAST:event_MSKKJ2ActionPerformed
    ...
    private void MnLaporanOperasiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiActionPerformed
        if(tabModekasir.getRowCount()==0){
            ...
            form.setLocationRelativeTo(internalFrame1);
            form.setNoRm(TNoRw.getText(),DTPCari2.getDate());
            form.setStatus("Ralan",tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),4).toString());
            form.tampil();
            form.setVisible(true);
            this.setCursor(Cursor.getDefaultCursor());
        }
    ...
    private void MnCoderManual2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCoderManual2ActionPerformed
        String tglawal = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),13).toString();
        String tglakhir = tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),13).toString();
        String carabayar = Sequel.cariIsi("select kd_pj from penjab where png_jawab like ?",tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),10).toString());
        if(akses.getinacbg_klaim_baru_manual2()==true){
            if(akses.getkode().equals("Admin Utama")){
                pilihpage="KlaimBaruManual2";
                judulform="::[ Klaim Manual Ke INACBG ]::";
                ...
                if(!coder_nik.equals("")){
                    ...
                    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                    try {
//                        inacbgklaim.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"inacbg/index.php?act=DetailKirim&corona="+aksiKorona+"&norawat="+TNoRw.getText()+"&codernik="+coder_nik+"&tahunawal="+Valid.SetYears(tglawal)+"&bulanawal="+Valid.SetMonths(tglawal)+"&tanggalawal="+Valid.SetDays(tglawal)+"&tahunakhir="+Valid.SetYears(tglakhir)+"&bulanakhir="+Valid.SetMonths(tglakhir)+"&tanggalakhir="+Valid.SetDays(tglakhir)+"&carabayar="+carabayar);
                        inacbgklaim.loadURL("http://"+koneksiDB.HOSTHYBRIDWEB()+":"+prop.getProperty("PORTWEB")+"/"+prop.getProperty("HYBRIDWEB")+"/"+"inacbg//login.php?act=login&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB()+"&page=KlaimBaruCostoms&corona="+aksiKorona+"&norawat="+TNoRw.getText()+"&codernik="+coder_nik+"&tahunawal="+Valid.SetYears(tglawal)+"&bulanawal="+Valid.SetMonths(tglawal)+"&tanggalawal="+Valid.SetDays(tglawal)+"&tahunakhir="+Valid.SetYears(tglakhir)+"&bulanakhir="+Valid.SetMonths(tglakhir)+"&tanggalakhir="+Valid.SetDays(tglakhir)+"&carabayar="+carabayar);
                    } catch (Exception ex) {
                        System.out.println("Notifikasi : "+ex);
                    }
    ...
    }//GEN-LAST:event_MnCoderManual2ActionPerformed
        ...
        if(tabModekasir.getRowCount()==0){
            ...
            if(tbKasirRalan.getSelectedRow()>-1){
                ...
                if(Sequel.cariRegistrasi(TNoRw.getText())>0){
                    ...
                    returjual.emptTeks();
                    returjual.isCek();
                    returjual.setPasien(tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),2).toString(),TNoRw.getText(),"Ralan");
    ...
    private void MnLaporanOperasiAnestesiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnLaporanOperasiAnestesiActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()>-1){
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                RMLaporanOperasiLokalAnestesi form=new RMLaporanOperasiLokalAnestesi(null,false);
                form.isCek();
                form.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
                form.setLocationRelativeTo(internalFrame1);
    ...
    }//GEN-LAST:event_MnLaporanOperasiAnestesiActionPerformed

    private void ppTBidBtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppTBidBtnPrintActionPerformed
        if(tabModekasir.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, table masih kosong...!!!!");
            TCari.requestFocus();
        }else{
            if(tbKasirRalan.getSelectedRow()!= -1){
                TxIdTb.setText(Sequel.cariIsi("select id_tb from data_tb_2 where no_rkm_medis=?",tbKasirRalan.getValueAt(tbKasirRalan.getSelectedRow(),2).toString()));
                WindowIdTB.setSize(590,80);
                WindowIdTB.setLocationRelativeTo(internalFrame1);
                WindowIdTB.setVisible(true);
            }                  
        }
    }//GEN-LAST:event_ppTBidBtnPrintActionPerformed

    private void TxIdTbKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TxIdTbKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_TxIdTbKeyPressed
    ...
    private void BtnSimpan2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan2ActionPerformed
        if(TNoRMCari.getText().trim().equals("")){
            Valid.textKosong(TNoRMCari,"No.RM");
        }else{
            LocalDate currentDate = LocalDate.now();
            DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd");
            String formattedDate = currentDate.format(formatter);
            Sequel.menyimpan("data_tb_2","'"+TNoRMCari.getText()+"','"+TxIdTb.getText()+"','"+formattedDate+"'","No.RM");
            WindowIdTB.setVisible(false);
        }
    ...
    private void BtnHapus2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapus2ActionPerformed
        if(TNoRMCari.getText().trim().equals("")){
            ...
            Sequel.queryu("delete from data_tb_2 where id_tb='"+TxIdTb.getText()+"' AND no_rkm_medis='"+TNoRMCari.getText()+"' ");
            WindowIdTB.setVisible(false);
        }
    ...
    */
    ...
    private javax.swing.JMenuItem MSKKJ2;
    ...
    private javax.swing.JMenuItem MnCoderManual2;
    ...
    private javax.swing.JMenuItem MnLaporanOperasiAnestesi;
    ...
    private javax.swing.JDialog WindowIdTB;
    ...
    private javax.swing.JMenuItem ppTBid;
    ...
    private void tampilkasir() {     
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_reg,reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                "reg_periksa.kd_dokter,dokter.nm_dokter,reg_periksa.no_rkm_medis,pasien.nm_pasien,poliklinik.nm_poli,"+
                "reg_periksa.p_jawab,pasien.alamat,reg_periksa.hubunganpj,reg_periksa.biaya_reg,reg_periksa.stts,penjab.png_jawab,concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur, "+
                "reg_periksa.status_bayar,reg_periksa.status_poli,reg_periksa.kd_pj,reg_periksa.kd_poli,pasien.no_tlp,pasien.no_peserta,pasien.no_ktp "+
                "from reg_periksa inner join dokter on reg_periksa.kd_dokter=dokter.kd_dokter inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                "inner join poliklinik on reg_periksa.kd_poli=poliklinik.kd_poli inner join penjab on reg_periksa.kd_pj=penjab.kd_pj where  "+
                ...
                "reg_periksa.p_jawab like ? or penjab.png_jawab like ? or pasien.alamat like ? or reg_periksa.status_bayar like ? or reg_periksa.hubunganpj like ? or pasien.no_peserta like ?)")+
                "order by "+order);
            try{
                ...
                while(rskasir.next()){
                    tabModekasir.addRow(new String[] {
                        ...
                        rskasir.getString("kd_pj"),rskasir.getString("kd_poli"),rskasir.getString("no_tlp"),rskasir.getString("no_peserta"),rskasir.getString("no_ktp")
                    });
                }                
            } catch(Exception e){
                System.out.println("Notifikasi : "+e);
    ...
    private void tampilkasir2() {                   
        ...
        try{   
            ...
            pskasir=koneksi.prepareStatement("select reg_periksa.no_rawat,reg_periksa.tgl_registrasi,reg_periksa.jam_reg,"+
                ...
                "reg_periksa.p_jawab,pasien.alamat,reg_periksa.hubunganpj,reg_periksa.stts,penjab.png_jawab,rujukan_internal_poli.kd_poli,"+
                "concat(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur)as umur,reg_periksa.kd_pj,pasien.no_tlp,pasien.no_peserta,pasien.no_ktp "+
                ...
                "or reg_periksa.p_jawab like ? or penjab.png_jawab like ? or pasien.alamat like ? or reg_periksa.hubunganpj like ? or pasien.no_peserta like ?)")+    
                "order by "+order);
            try{
                pskasir.setString(1,Valid.SetTgl(DTPCari1.getSelectedItem()+""));
                pskasir.setString(2,Valid.SetTgl(DTPCari2.getSelectedItem()+""));
                ...
                while(rskasir.next()){
                    tabModekasir2.addRow(new String[] {
                        ...
                        rskasir.getString("nm_poli"),rskasir.getString("p_jawab"),rskasir.getString("alamat"),rskasir.getString("hubunganpj"),
                        rskasir.getString("png_jawab"),rskasir.getString("stts"),rskasir.getString("no_rawat"),rskasir.getString("tgl_registrasi"),
                        rskasir.getString("jam_reg"),rskasir.getString("kd_poli"),rskasir.getString("kd_pj"),rskasir.getString("no_tlp"),rskasir.getString("no_peserta"),rskasir.getString("no_ktp")
                    });
                }                
            } catch(Exception e){
                System.out.println("Notifikasi : "+e);
    ...
    public void isCek(){
        ...
        MnCoderManual2.setEnabled(akses.getinacbg_klaim_baru_manual2());
        if(akses.getkode().equals("Admin Utama")){
