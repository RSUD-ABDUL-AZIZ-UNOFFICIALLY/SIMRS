...
public final class DlgPeresepanPulangDokter extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "18-10-2024" }));
...
private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRw.getText().trim().equals("")||TPasien.getText().trim().equals("")){
            ...
            if (reply == JOptionPane.YES_OPTION) {                 
                ...
                sukses=true;
                if(ubah==false){
                    if(Sequel.menyimpantf2("permintaan_resep_pulang","?,?,?,?,?,?,'0000-00-00','00:00:00'","Nomer Resep",6,new String[]{
                    ...
                    Sequel.meghapus("resep_dokter_p_racikan","no_resep",NoResep.getText());
                    Sequel.meghapus("resep_dokter_p_racikan_detail","no_resep",NoResep.getText());
                    ubah=false;
                    simpandata();
                }                                                      
...
private void ppBersihkanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppBersihkanActionPerformed
    ...
    */
    ...
    public void emptTeksobat() {
        if(ChkRM.isSelected()==true){
//            Valid.autoNomer3("select ifnull(RIGHT(CONVERT(MAX(resep_obat.no_resep),signed),4),0) from resep_obat where resep_obat.tgl_peresepan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' or resep_obat.tgl_perawatan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ",
//            Valid.autoNomer3("select ifnull(RIGHT(CONVERT(MAX(resep_obat.no_resep),signed),4),0) from resep_obat where resep_obat.tgl_peresepan='"+Valid.SetTgl(DTPBeri.getSelectedItem()+"")+"' ORDER BY resep_obat.tgl_peresepan desc ",
//                DTPBeri.getSelectedItem().toString().substring(6,10)+DTPBeri.getSelectedItem().toString().substring(3,5)+DTPBeri.getSelectedItem().toString().substring(0,2),4,NoResep);        
            ...
            NoResep.setText(String.format("%014d", currentTimeMillis));
        } 
    }
        ...
        try {
            ...
            if(kenaikan>0){
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,detail_permintaan_resep_pulang.jml, detail_permintaan_resep_pulang.dosis "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join detail_permintaan_resep_pulang on detail_permintaan_resep_pulang.kode_brng=databarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and "+
                        " detail_permintaan_resep_pulang.no_resep=? group by gudangbarang.kode_brng order by databarang.nama_brng");
                }else{
                    qrystokkosong="";
                    if(STOKKOSONGRESEP.equals("no")){
                        qrystokkosong=" and gudangbarang.stok>0 ";
                    ...
                    psresepasuransi=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                        " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,detail_permintaan_resep_pulang.jml, detail_permintaan_resep_pulang.dosis "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join detail_permintaan_resep_pulang on detail_permintaan_resep_pulang.kode_brng=databarang.kode_brng "+
                        " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and "+
                        " detail_permintaan_resep_pulang.no_resep=? order by databarang.nama_brng");
                }
                try{
                    psresepasuransi.setDouble(1,kenaikan);
                    psresepasuransi.setString(2,bangsal);
                        ...
                        while(rsobat.next()){
                            if(rsobat.getDouble("jml")>rsobat.getDouble("stok")){
                                ...
                                tabModeResep.addRow(new Object[] {
                                   ...
                                   rsobat.getString("kode_sat"),rsobat.getString("letak_barang"),Valid.roundUp(rsobat.getDouble("harga"),100),
                                   rsobat.getString("nama"),rsobat.getString("dosis"),rsobat.getString("nama_industri"),
                                   rsobat.getDouble("h_beli"),rsobat.getDouble("stok")
                                }); 
                            }else{
                                tabModeResep.addRow(new Object[] {
                ...
                if(aktifkanbatch.equals("yes")){
                    ...
                    psresep=koneksi.prepareStatement(
                        ...
                        " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                        " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                        " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,detail_permintaan_resep_pulang.jml, detail_permintaan_resep_pulang.dosis "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join detail_permintaan_resep_pulang on detail_permintaan_resep_pulang.kode_brng=databarang.kode_brng "+
                    ...
                    psresep=koneksi.prepareStatement(
                        ...
                        " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                        " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                        " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,detail_permintaan_resep_pulang.jml, detail_permintaan_resep_pulang.dosis "+
                        " from databarang inner join jenis on databarang.kdjns=jenis.kdjns "+
                        " inner join industrifarmasi on industrifarmasi.kode_industri=databarang.kode_industri "+
                        " inner join gudangbarang on databarang.kode_brng=gudangbarang.kode_brng "+
                        " inner join detail_permintaan_resep_pulang on detail_permintaan_resep_pulang.kode_brng=databarang.kode_brng "+
            ...
            psresep=koneksi.prepareStatement(
                    "select resep_dokter_p_racikan.no_racik,resep_dokter_p_racikan.nama_racik,"+
                    "resep_dokter_p_racikan.kd_racik,metode_racik.nm_racik as metode,"+
                    "resep_dokter_p_racikan.jml_dr,resep_dokter_p_racikan.aturan_pakai,"+
                    "resep_dokter_p_racikan.keterangan from resep_dokter_p_racikan inner join metode_racik "+
                    "on resep_dokter_p_racikan.kd_racik=metode_racik.kd_racik where "+
                    "resep_dokter_p_racikan.no_resep=? ");
            try {
                    ...
                    if(kenaikan>0){
                        if(aktifkanbatch.equals("yes")){
                            ...
                            ps2=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                                " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,databarang.kapasitas,resep_dokter_p_racikan_detail.p1,"+
                                " resep_dokter_p_racikan_detail.p2,resep_dokter_p_racikan_detail.kandungan,resep_dokter_p_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_p_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_p_racikan_detail.kode_brng=databarang.kode_brng "+
                                " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch<>'' and gudangbarang.no_faktur<>'' and gudangbarang.kd_bangsal=? and "+
                                " resep_dokter_p_racikan_detail.no_resep=? and resep_dokter_p_racikan_detail.no_racik=? group by gudangbarang.kode_brng order by databarang.nama_brng");
                        }else{
                            qrystokkosong="";
                            if(STOKKOSONGRESEP.equals("no")){
                                qrystokkosong=" and gudangbarang.stok>0 ";
                            ...
                            ps2=koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng,jenis.nama, databarang.kode_sat,(databarang.h_beli+(databarang.h_beli*?)) as harga,"+
                                " databarang.letak_barang,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,databarang.kapasitas,resep_dokter_p_racikan_detail.p1,"+
                                " resep_dokter_p_racikan_detail.p2,resep_dokter_p_racikan_detail.kandungan,resep_dokter_p_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_p_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_p_racikan_detail.kode_brng=databarang.kode_brng "+
                                " where databarang.status='1' "+qrystokkosong+" and gudangbarang.no_batch='' and gudangbarang.no_faktur='' and gudangbarang.kd_bangsal=? and "+
                                " resep_dokter_p_racikan_detail.no_resep=? and resep_dokter_p_racikan_detail.no_racik=? order by databarang.nama_brng");
                        }
                        try{ 
                        ...
                        if(aktifkanbatch.equals("yes")){
                            ...
                            ps2=koneksi.prepareStatement(
                                ...
                                " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                                " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                                " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,sum(gudangbarang.stok) as stok,databarang.kapasitas,resep_dokter_p_racikan_detail.p1,"+
                                " resep_dokter_p_racikan_detail.p2,resep_dokter_p_racikan_detail.kandungan,resep_dokter_p_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_p_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_p_racikan_detail.kode_brng=databarang.kode_brng "+
                            ...
                            ps2=koneksi.prepareStatement(
                                ...
                                " databarang.karyawan,databarang.ralan,databarang.beliluar,databarang.kelas1," +
                                " databarang.kelas2,databarang.kelas3,databarang.vip,databarang.vvip,"+
                                " databarang.letak_barang,databarang.utama,industrifarmasi.nama_industri,databarang.h_beli,gudangbarang.stok,databarang.kapasitas,resep_dokter_p_racikan_detail.p1,"+
                                " resep_dokter_p_racikan_detail.p2,resep_dokter_p_racikan_detail.kandungan,resep_dokter_p_racikan_detail.jml "+
                                " from databarang inner join jenis inner join industrifarmasi inner join gudangbarang inner join resep_dokter_p_racikan_detail "+
                                " on databarang.kdjns=jenis.kdjns and databarang.kode_brng=gudangbarang.kode_brng "+
                                " and industrifarmasi.kode_industri=databarang.kode_industri and resep_dokter_p_racikan_detail.kode_brng=databarang.kode_brng "+
        ...
        try {
                    ...
                    if(tbResep.getValueAt(i,0).toString().equals("true")){
                        ...
                        try {
                            ...
                            if(carikapasitas.next()){ 
                                if(Sequel.menyimpantf2("detail_permintaan_resep_pulang","?,?,?,?","data",4,new String[]{
            ...
            for(i=0;i<tbObatResepRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbObatResepRacikan.getValueAt(i,4).toString())>0){ 
                    if(Sequel.menyimpantf2("resep_dokter_p_racikan","?,?,?,?,?,?,?","resep obat racikan",7,new String[]{
            ...
            for(i=0;i<tbDetailResepObatRacikan.getRowCount();i++){ 
                if(Valid.SetAngka(tbDetailResepObatRacikan.getValueAt(i,13).toString())>0){
                    if(Sequel.menyimpantf2("resep_dokter_p_racikan_detail","?,?,?,?,?,?,?","resep dokter racikan detail",7,new String[]{
