...
public final class DlgResepObat extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        ppEResep.setText("Cetak e-resep");
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-04-2022 12:23:50" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-04-2022 12:23:51" }));
        ...
        DTPBeri.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "19-04-2022" }));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
        ...
        if(tabMode.getRowCount()==0){
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep5.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir, "+
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,databarang.nama_brng,"+
                    "aturan_pakai.aturan,detail_pemberian_obat.jml,kodesatuan.satuan,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,resep_obat.status "+
                    "from resep_obat inner join reg_periksa inner join pasien inner join "+
                    "aturan_pakai inner join databarang inner join detail_pemberian_obat "+
                    "inner join kodesatuan on resep_obat.no_rawat=reg_periksa.no_rawat  "+
                    "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and "+
            ...
            if(Sequel.cariInteger(
                ...
                Valid.MyReportqry("rptItemResep6.jasper","report","::[ Aturan Pakai Obat ]::",
                    "select resep_obat.no_resep,resep_obat.tgl_perawatan,resep_obat.jam,pasien.tgl_lahir," +
                    "resep_obat.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,obat_racikan.nama_racik," +
                    "obat_racikan.aturan_pakai,obat_racikan.keterangan,obat_racikan.jml_dr,metode_racik.nm_racik,pasien.jk,reg_periksa.umurdaftar,reg_periksa.sttsumur,resep_obat.status " +
                    "from resep_obat inner join reg_periksa inner join pasien inner join " +
                    "obat_racikan inner join metode_racik on resep_obat.no_rawat=reg_periksa.no_rawat " +
                    "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis " +
                    "and obat_racikan.kd_racik=metode_racik.kd_racik " +
    ...
    private void ppEResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppEResepActionPerformed
        Valid.panggilUrl("billing/LembarEresep.php?petugas="+akses.getkode().replaceAll(" ","_")+"&noresep="+NoResep.getText().replaceAll(" ","_")+"&usere="+koneksiDB.USERHYBRIDWEB()+"&passwordte="+koneksiDB.PASHYBRIDWEB());
