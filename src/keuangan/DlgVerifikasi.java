...
public class DlgVerifikasi extends javax.swing.JDialog {
    ...
    private PreparedStatement ps,psrawatjalandr,psrawatjalandrpr,psrawatjalanpr,psrawatinapdr,psrawatinapdrpr,psrawatinappr,psbiayaoperator1,psbiayaoperator2,psbiayaoperator3,psbiayadokter_anak,
    ...
    private ResultSet rs,rsrawatjalandr,rsrawatjalandrpr,rsrawatjalanpr,rsrawatinapdr,rsrawatinapdrpr,rsrawatinappr,rsbiayaoperator1,rsbiayaoperator2,rsbiayaoperator3,rsbiayadokter_anak,
            rsbiayadokter_anestesi,rsdetaillab,rsperiksa_lab,rsperiksa_radiologi,rsbiaya_dokter_pjanak,rsbiaya_dokter_umum;
    /** Creates new form DlgProgramStudi
     * @param parent
     * @param modal */
    public DlgVerifikasi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();

        Object[] row={"No.","Tgl.Pelunasan","Tgl.[Jam] Masuk","Tgl.[Jam] Keluar","No.Rawat","No.RM","Nama Pasien","Poli","Gol.Pasien","Biaya Tindakan","Biaya Farmasi","Total Biaya","Tgl.Pembayaran","Tagih Akhir","Jumlah Bayar","Sisa Tagihan","Kasir","Status Pelunasan"};
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Rekap Harian Kasir ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        TabRawat.addTab("Ralan", scrollPane1);
        ...
        TabRawat.addTab("Ranap", scrollPane2);
        ...
        scrollPane3.setViewportView(LoadHTML1);

        TabRawat.addTab("IGD", scrollPane3);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            DlgVerifikasi dialog = new DlgVerifikasi(new javax.swing.JFrame(), true);
...
//        double jmlh1=0,jmlh2=0,jmlh3=0,totaljmlh=0;
//         try{             
...
//                    "	penjab\n" +
//                    "	ON \n" +
//                    "		reg_periksa.kd_pj = penjab.kd_pj where status_bayar='Sudah Bayar' and status_lanjut='Ralan' AND concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg) between ? and ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? ");
//            try {
...
//                    total=0;
//                    z=0;
//                    jmlh1=0;jmlh2=0;jmlh3=0;  
//                    if(chkRalan.isSelected()==true){
//                         //rawat jalan     
//                         psrawatjalandr=koneksi.prepareStatement("SELECT\n" +
//                            "	reg_periksa.no_rawat, \n" +
//                            "	reg_periksa.tgl_registrasi, \n" +
//                            "	reg_periksa.jam_reg, \n" +
//                            "	rawat_jl_dr.stts_bayar, \n" +
//                            "	reg_periksa.kd_pj, \n" +
//                            "	SUM(rawat_jl_dr.biaya_rawat) AS total_biaya_rawat\n" +
//                            "FROM\n" +
//                            "	reg_periksa "+
//                            "   INNER JOIN\n" +
//                            "	penjab\n" +
...
//                            "	rawat_jl_dr\n" +
//                            "	ON \n" +
//                            "		reg_periksa.no_rawat = rawat_jl_dr.no_rawat\n" +
//                            "WHERE\n" +
//                            "	concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg) between ? and ? and rawat_jl_dr.no_rawat = ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? \n" +
//                            "GROUP BY\n" +
//                            "	rawat_jl_dr.no_rawat");
//                         psrawatjalandrpr=koneksi.prepareStatement("SELECT\n" +
//                            "	reg_periksa.no_rawat, \n" +
//                            "	reg_periksa.tgl_registrasi, \n" +
//                            "	reg_periksa.jam_reg, \n" +
//                            "	rawat_jl_drpr.stts_bayar, \n" +
//                            "	reg_periksa.kd_pj, \n" +
//                            "	SUM(rawat_jl_drpr.biaya_rawat) AS total_biaya_rawat\n" +
//                            "FROM\n" +
//                            "	reg_periksa "+
//                            "   INNER JOIN\n" +
//                            "	penjab\n" +
...
//                            "	rawat_jl_drpr\n" +
//                            "	ON \n" +
//                            "		reg_periksa.no_rawat = rawat_jl_drpr.no_rawat\n" +
//                            "WHERE\n" +
//                            "	concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg) between ? and ? and rawat_jl_drpr.no_rawat = ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? \n" +
//                            "GROUP BY\n" +
//                            "	rawat_jl_drpr.no_rawat");
//                         psrawatjalanpr=koneksi.prepareStatement("SELECT\n" +
//                            "	reg_periksa.no_rawat, \n" +
//                            "	reg_periksa.tgl_registrasi, \n" +
//                            "	reg_periksa.jam_reg, \n" +
//                            "	rawat_jl_pr.stts_bayar, \n" +
//                            "	reg_periksa.kd_pj, \n" +
//                            "	SUM(rawat_jl_pr.biaya_rawat) AS total_biaya_rawat\n" +
//                            "FROM\n" +
//                            "	reg_periksa "+
//                            "   INNER JOIN\n" +
//                            "	penjab\n" +
...
//                            "	rawat_jl_pr\n" +
//                            "	ON \n" +
//                            "		reg_periksa.no_rawat = rawat_jl_pr.no_rawat\n" +
//                            "WHERE\n" +
//                            "	concat(reg_periksa.tgl_registrasi,' ',reg_periksa.jam_reg) between ? and ? and rawat_jl_pr.no_rawat = ? and concat(reg_periksa.kd_pj,penjab.png_jawab) like ? \n" +
//                            "GROUP BY\n" +
...
//                             psrawatjalandr.setString(3,rs.getString("no_rawat"));
...
//                             psrawatjalandrpr.setString(3,rs.getString("no_rawat"));
...
//
//                             psrawatjalanpr.setString(1,Valid.SetTgl(Tgl1.getSelectedItem()+"")+" "+CmbJam.getSelectedItem()+":"+CmbMenit.getSelectedItem()+":"+CmbDetik.getSelectedItem());
//                             psrawatjalanpr.setString(2,Valid.SetTgl(Tgl2.getSelectedItem()+"")+" "+CmbJam2.getSelectedItem()+":"+CmbMenit2.getSelectedItem()+":"+CmbDetik2.getSelectedItem());
//                             psrawatjalanpr.setString(3,rs.getString("no_rawat"));
//                             psrawatjalanpr.setString(4,"%"+KdCaraBayar.getText()+NmCaraBayar.getText()+"%");
//                             rsrawatjalanpr=psrawatjalanpr.executeQuery();
//                             rsrawatjalanpr.last();
//                             
//                                rsrawatjalandr.beforeFirst();
//                                while(rsrawatjalandr.next()){
//                                    jmlh1=jmlh1+rsrawatjalandr.getDouble("total_biaya_rawat");
//                                }
//                                rsrawatjalandrpr.beforeFirst();
//                                while(rsrawatjalandrpr.next()){
//                                    jmlh2=jmlh2+rsrawatjalandrpr.getDouble("total_biaya_rawat");
//                                }
//                                rsrawatjalanpr.beforeFirst();
//                                while(rsrawatjalanpr.next()){
//                                    jmlh3=jmlh3+rsrawatjalanpr.getDouble("total_biaya_rawat");
//                                }
//                                totaljmlh=jmlh1+jmlh2+jmlh3;
//                         } catch (Exception e) {
...
//                    }
//
//                    tabMode.addRow(new Object[]{i+".","",rs.getString("tgl_registrasi")+" "+rs.getString("jam_reg"),"",
//                        rs.getString("no_rawat"),rs.getString("no_rkm_medis"),rs.getString("nm_pasien"),
//                        rs.getString("nm_poli"),rs.getString("png_jawab"),totaljmlh,"","","","","","","",""});
//                 i++;
//                 } 
//            } catch (Exception e) {
