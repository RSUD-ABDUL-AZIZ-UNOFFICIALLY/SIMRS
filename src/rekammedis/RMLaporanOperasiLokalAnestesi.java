 ...
 * @author perpustakaan
 */
public final class RMLaporanOperasiLokalAnestesi extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMLaporanOperasiLokalAnestesi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        isCek2();
    ...
    private void initComponents() {
        ...
        TglOpMulai.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "03-07-2024 09:05:48" }));
...
//            Valid.textKosong(btnPerawat3,"Perawat3");
            ...
            if(Sequel.menyimpantf("laporan_operasi_lokal_anestesi","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","Data Laporan Operasi Lokal",24,new String[]{
                TNoRw.getText(),
    ...
    private void MnCetakLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakLaporanActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReport("rptLaporanOperasiLokalAnestesi.jasper","report","::[ Laporan Operasi dengan Lokal Anestesi ]::",param);
        }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMLaporanOperasiLokalAnestesi dialog = new RMLaporanOperasiLokalAnestesi(new javax.swing.JFrame(), true);
    ...
    public void tampil() {
        ...
        try{
            ...
            ps=koneksi.prepareStatement(
                ...
                "	petugas AS perawat3\n" +
                "	ON \n" +
                "		laporan_operasi_lokal_anestesi.perawat3 = perawat3.nip where "+
                "laporan_operasi_lokal_anestesi.tanggal_mulai between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                "laporan_operasi_lokal_anestesi.dokter like ? or dokter.nm_dokter like ?) order by laporan_operasi_lokal_anestesi.tanggal_mulai"
            );
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            TxDiagnosaPraBedah.setText(tbObat.getValueAt(tbObat.getSelectedRow(),16).toString());
    ...
    private void hapus() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            if(Sequel.queryu2tf("delete from laporan_operasi_lokal_anestesi where no_rawat=? and tanggal_mulai=? and dokter=?",3,new String[]{
    ...
    private void ganti() {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            if(Sequel.mengedittf("laporan_operasi_lokal_anestesi",
