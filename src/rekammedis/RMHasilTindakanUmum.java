 ...
 * @author perpustakaan
 */
public final class RMHasilTindakanUmum extends javax.swing.JDialog {
     ...
     * @param parent
     * @param modal */
    public RMHasilTindakanUmum(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        tabMode=new DefaultTableModel(null,new Object[]{
                "No.Rawat","No.RM","Nama Pasien","Tgl.Lahir","Kode Dokter","Nama Dokter","Tanggal","Tindakan","Diagnosa Klinis","Kesimpulan"
            }){
        ...
        nmTindakan.setDocument(new batasInput((int)200).getKata(nmTindakan));
        DiagnosaKlinis.setDocument(new batasInput((int)200).getKata(DiagnosaKlinis));
        Kesimpulan.setDocument(new batasInput((int)5000).getKata(Kesimpulan));
        ...
        templateTindakan.addWindowListener(new WindowListener() {
            @Override
            public void windowOpened(WindowEvent e) {}
            @Override
            public void windowClosing(WindowEvent e) {}
            @Override
            public void windowClosed(WindowEvent e) {
                if(templateTindakan.getTable().getSelectedRow()!= -1){
                    nmTindakan.setText(templateTindakan.getTable().getValueAt(templateTindakan.getTable().getSelectedRow(),1).toString());
                    Kesimpulan.setText(templateTindakan.getTable().getValueAt(templateTindakan.getTable().getSelectedRow(),2).toString());
                    nmTindakan.requestFocus();
                }
            }
            @Override
            public void windowIconified(WindowEvent e) {}
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Hasil Pemeriksaan Tindakan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(50, 50, 50))); // NOI18N
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "21-08-2024 10:53:44" }));
        ...
        jLabel30.setBounds(0, 80, 60, 23);

        nmTindakan.setFocusTraversalPolicyProvider(true);
        ...
        nmTindakan.setBounds(60, 80, 265, 23);
        ...
        BtnTindakan.setBounds(330, 80, 28, 23);
        ...
        jLabel48.setText("Laporan Tindakan :");
        jLabel48.setName("jLabel48"); // NOI18N
        FormInput.add(jLabel48);
        jLabel48.setBounds(0, 120, 100, 20);
        ...
        scrollPane21.setBounds(105, 120, 620, 540);
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            Valid.MyReportqry("rptCetakHasilPemeriksaanTindakan.jasper","report","::[ Formulir Hasil Pemeriksaan ]::",
                ...
                " hasil_pemeriksaan_tindakan.tanggal,CONCAT(reg_periksa.umurdaftar,' ',reg_periksa.sttsumur) AS umur,\n" +
                " hasil_pemeriksaan_tindakan.kd_dokter,dokter.nm_dokter,\n" +
                " hasil_pemeriksaan_tindakan.diagnosa_klinis,hasil_pemeriksaan_tindakan.tindakan,\n" +
                " hasil_pemeriksaan_tindakan.kesimpulan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis \n" +
                " inner join hasil_pemeriksaan_tindakan on reg_periksa.no_rawat=hasil_pemeriksaan_tindakan.no_rawat \n" +
                " inner join dokter on hasil_pemeriksaan_tindakan.kd_dokter=dokter.kd_dokter where hasil_pemeriksaan_tindakan.no_rawat='"+tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()+"'",param);
        }
    ...
    private void DiagnosaKlinisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_DiagnosaKlinisKeyPressed
        Valid.pindah(evt,nmTindakan,Kesimpulan);
    ...
    private void BtnTindakanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnTindakanActionPerformed
        templateTindakan.setSize(internalFrame1.getWidth()-20,internalFrame1.getHeight()-20);
        templateTindakan.setLocationRelativeTo(internalFrame1);
        templateTindakan.setAlwaysOnTop(false);
        templateTindakan.setVisible(true);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            RMHasilTindakanUmum dialog = new RMHasilTindakanUmum(new javax.swing.JFrame(), true);
        ...
        try{
            if(TCari.getText().trim().equals("")){
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_tindakan.tanggal,"+
                        "hasil_pemeriksaan_tindakan.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_tindakan.diagnosa_klinis,hasil_pemeriksaan_tindakan.tindakan,"+
                        "hasil_pemeriksaan_tindakan.kesimpulan from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis "+
                        "inner join hasil_pemeriksaan_tindakan on reg_periksa.no_rawat=hasil_pemeriksaan_tindakan.no_rawat "+
                        "inner join dokter on hasil_pemeriksaan_tindakan.kd_dokter=dokter.kd_dokter where "+
                        "hasil_pemeriksaan_tindakan.tanggal between ? and ? order by hasil_pemeriksaan_tindakan.tanggal");
            }else{
                ps=koneksi.prepareStatement(
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.tgl_lahir,hasil_pemeriksaan_tindakan.tanggal,"+
                        "hasil_pemeriksaan_tindakan.kd_dokter,dokter.nm_dokter,hasil_pemeriksaan_tindakan.diagnosa_klinis,hasil_pemeriksaan_tindakan.tindakan,"+
                        ...
                        "inner join hasil_pemeriksaan_tindakan on reg_periksa.no_rawat=hasil_pemeriksaan_tindakan.no_rawat "+
                        "inner join dokter on hasil_pemeriksaan_tindakan.kd_dokter=dokter.kd_dokter where "+
                        "hasil_pemeriksaan_tindakan.tanggal between ? and ? and (reg_periksa.no_rawat like ? or pasien.no_rkm_medis like ? or pasien.nm_pasien like ? or "+
                        "hasil_pemeriksaan_tindakan.kd_dokter like ? or dokter.nm_dokter like ?) order by hasil_pemeriksaan_tindakan.tanggal");
            }
            ...
            try {
                ...
                while(rs.next()){
                    tabMode.addRow(new String[]{
                        ...
                        rs.getString("tindakan"),rs.getString("diagnosa_klinis"),rs.getString("kesimpulan")
                    });
                }
            } catch (Exception e) {
    ...
    private void getData() {
        if(tbObat.getSelectedRow()!= -1){
            ...
            nmTindakan.setText(tbObat.getValueAt(tbObat.getSelectedRow(),7).toString());
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from hasil_pemeriksaan_tindakan where no_rawat=?",1,new String[]{
    ...
    private void ganti() {
        if(Sequel.mengedittf("hasil_pemeriksaan_tindakan","no_rawat=?","no_rawat=?,tanggal=?,kd_dokter=?,diagnosa_klinis=?,tindakan=?,kesimpulan=?",7,new String[]{
                ...
                nmTindakan.getText(),DiagnosaKlinis.getText(),Kesimpulan.getText(),tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
            })==true){
                ...
                tbObat.setValueAt(nmTindakan.getText(),tbObat.getSelectedRow(),7);
    ...
    private void simpan() {
        if(Sequel.menyimpantf("hasil_pemeriksaan_tindakan","?,?,?,?,?,?","No.Rawat",6,new String[]{
                TNoRw.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),KdDokter.getText(),
                DiagnosaKlinis.getText(),nmTindakan.getText(),Kesimpulan.getText()
            })==true){
                tabMode.addRow(new String[]{
                    TNoRw.getText(),TNoRM.getText(),TPasien.getText(),TglLahir.getText(),KdDokter.getText(),NmDokter.getText(),Valid.SetTgl(Tanggal.getSelectedItem()+"")+" "+Tanggal.getSelectedItem().toString().substring(11,19),
                    nmTindakan.getText(),DiagnosaKlinis.getText(),Kesimpulan.getText()
                });
                emptTeks();
                LCount.setText(""+tabMode.getRowCount());
        }
