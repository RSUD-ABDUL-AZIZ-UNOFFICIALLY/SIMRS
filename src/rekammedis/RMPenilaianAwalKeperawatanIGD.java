...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        Tekanan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "TAK", "Sakit Kepala", "Muntah", "Pusing", "Bingung" }));
        ...
        Neurosensorik.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "TAK", "Spasme Otot", "Perubahan Sensorik", "Perubahan Motorik", "Perubahan Bentuk Ekstremitas", "Penurunan Tingkat Kesadaran", "Fraktur/Dislokasi", "Luksasio", "Kerusakan Jaringan/Luka" }));
        ...
        Integumen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Normal", "TAK", "Luka Bakar", "Luka Robek", "Lecet", "Luka Decubitus", "Luka Gangren" }));
